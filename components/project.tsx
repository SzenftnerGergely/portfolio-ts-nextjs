...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
    ...
    return (
        ...
        sm:h-[20rem] hover:bg-gray-200 sm:group-even:pl-8
        transition rounded-lg dark:bg-white/10 
                ...
                flex flex-col h-full sm:group-even:ml-[18rem] '>
                    ...
                    <ul className='flex flex-wrap mt-4 gap-2 sm:mt-auto'>
                        {tags.map((tag, index) =>
                            ...
                            dark:text-white/70' key={index}>{tag}</li>
                        )}
                    </ul>
                </div>
                <Image
                    ...
                    group-hover:-rotate-2 group-hover:scale-[1.04] transition
